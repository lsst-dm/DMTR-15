...
\setDocAbstract{%
This brief report describe measurements of interest that were carried out for release v13.0 of the Science Pipeline.

The report for the previous version can be found in \citeds{DMTR-14}.
}
